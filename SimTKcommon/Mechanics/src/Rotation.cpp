    ...
    RealP angle2, const CoordinateAxis& axis2In )  
{
    ...
    const RealP c1 = NTraits<RealP>::cos( angle1 ),  s1 = NTraits<RealP>::sin( angle1 );
    const RealP c2 = NTraits<RealP>::cos( angle2 ),  s2 = NTraits<RealP>::sin( angle2 );
...
Rotation_<P>::setRotationFromThreeAnglesThreeAxes
  ( BodyOrSpaceType bodyOrSpace, 
    ...
    const RealP c1 = NTraits<RealP>::cos( angle1 ),  s1 = NTraits<RealP>::sin( angle1 );
    const RealP c2 = NTraits<RealP>::cos( angle2 ),  s2 = NTraits<RealP>::sin( angle2 );
    const RealP c3 = NTraits<RealP>::cos( angle3 ),  s3 = NTraits<RealP>::sin( angle3 );
