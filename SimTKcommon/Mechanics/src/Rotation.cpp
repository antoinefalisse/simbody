...
template class Rotation_<Recorder>;
template class InverseRotation_<Recorder>;
#endif
...
#ifdef SimTK_REAL_IS_ADOUBLE
template SimTK_SimTKCOMMON_EXPORT std::ostream&
operator<<(std::ostream&, const Rotation_<Recorder>&);
template SimTK_SimTKCOMMON_EXPORT std::ostream&
operator<<(std::ostream&, const InverseRotation_<Recorder>&);
#endif
