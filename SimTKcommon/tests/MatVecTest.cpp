...
void testElementwiseOps() {
    ...
    SimTK_TEST_EQ_TOL(dr, Row3(Real(1)/5, Real(2)/4, Real(3)/10),1e-5);
    ...
    SimTK_TEST_EQ_TOL(dy, SymMat22(Real(1)/5,Real(2)/4,Real(3)/10), 1e-5);
}
...
void testMiscellaneous()
{
   ...
   // cout << "after -~cv2[1]=(11.1f,22.3f), cv2= " << cv2 << endl; 
    ...
    negator<SimTK::Real> nd(100); cout << endl << "nd=" << nd << endl;
    cout << "nv1=" << nv1 << endl;
